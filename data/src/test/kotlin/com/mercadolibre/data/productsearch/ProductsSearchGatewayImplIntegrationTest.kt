...
import com.mercadolibre.data.productsearch.mapper.ProductsSearchBackendResponseMapperImpl
...
class ProductsSearchGatewayImplIntegrationTest {
    ...
    private val productsMapper = ProductsSearchBackendResponseMapperImpl()
    ...
    fun `given a query string, when execute is called, then returns a list of products`() {
        ...
        val gateway: Repository<String, List<Product>> =
            ProductsSearchRepository(service, errorSerializer, productsMapper)
        val query = "canon"
